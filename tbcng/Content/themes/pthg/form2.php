   ...
   // validation
    if(empty($_POST['name3']))
    {
      ...
      die();
       ...
       echo "Fields are not filled properly";
        die();
    }else if(empty($_POST['subject3'])){
       echo "Fields are not filled properly";
       die();
    }else if(empty($_POST['phone3'])){
       echo "Fields are not filled properly";
       die();

    }else if(empty($_POST['comment3'])){
       echo "Fields are not filled properly";
       die();
    }else{     
    ...
    $name = $_POST['name3']; // required
    $email = $_POST['email3']; // required
    $subject = $_POST['subject3']; // required
    $phone = $_POST['phone3']; // required
    $comments = $_POST['comment3'];
    ...
    $email_message .= "<tr style='background: #eee;'><td><strong>Name:</strong> </td><td>" . strip_tags($_POST['name3']) . "</td></tr>";
    $email_message .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($_POST['email3']) . "</td></tr>";
    $email_message .= "<tr><td><strong>Subject:</strong> </td><td>" . strip_tags($_POST['subject3']) . "</td></tr>";
    $email_message .= "<tr><td><strong>Phone:</strong> </td><td>" . strip_tags($_POST['phone3']) . "</td></tr>";
    $email_message .= "<tr><td><strong>Comment:</strong> </td><td>" . strip_tags($_POST['comment3']) . "</td></tr>";
    $email_message .= "</table>";
